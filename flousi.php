...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS =>'{
    ...
    "accept_card": "true",
    "amount": "'.$amount.'",
    "success_link": "http://localhost/carshop/paiement.php?amount='.$amount.'&&userID='.$userID.'&&carID='.$carID.'",
    "fail_link": "http://localhost/carshop/paiement.php?amount='.$amount.'&&userID='.$userID.'&&carID='.$carID.'",
